...
.textou {font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 10px; color: #000000; text-decoration: none;}
.texto {font-family: tahoma; font-size: 11px; color: #000000; text-decoration: none;}
#fi1 {
...
<tr><td><input type="text" name="login" id="fi1" size="12" value="<?php echo "$mensagem_erro"; ?>"></td><td><input type="password" name="senha" id="fi1"size="12px"></td><td><button type="submit" name="logar" value="Logar" id="input1">Logar</button></td></tr>
<tr><td><input type="checkbox" name="lembrar" id="fi2"><span class="texto">Manter-me conectado</span></td><td></td><td></td></tr>
</table>
</form>
</body>
