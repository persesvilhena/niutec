  ...
  <tr>
    <td><table width="550" border="0" cellspacing="0" cellpadding="5"></td></tr>
      ...
      <tr>
        <td>Descricao1:</td>
        <td><label>
          <textarea id="cordoinput" type="text" name="descricao1" rows="10" cols="50"><?php echo $row2["descricao1"]; ?></textarea>
		</label></td>
      </tr>
	        <tr>
        <td>Descricao2:</td>
        <td><label>
          <textarea id="cordoinput" type="text" name="descricao2" rows="10" cols="50"><?php echo $row2["descricao2"]; ?></textarea>
		</label></td>
      </tr>
	        <tr>
        <td>Cidade:</td>
...
<a href="index.php?perfil" target="_top" class="botao">Voltar</a>
</span></div></div>
